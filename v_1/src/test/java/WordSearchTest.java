...
public class WordSearchTest {
    ...
    public static List<Object[]> cases() throws FileNotFoundException {
        return Arrays.asList(new Object[][]{
                {Utils.readLinesFromFile(new File("src/test/resources/input01.txt")), 10, 150, Arrays.asList("окружалась",
                        "переодетым", "чудовищных", "порядочным", "загадочных", "привлекала", "полагалось", "появлялись",
                        "вообразить", "отсиживать", "прекрасные", "разбойники", "признаться", "останешься", "правильным",
                        "сладостный", "собственно", "снадобьями", "опрятность", "образцовое", "призраками", "служанками",
                        "библейское", "прекрасной")},
                {Utils.readLinesFromFile(new File("src/test/resources/input02.txt")), 9, 5, Arrays.asList("рассказал",
                        ...
                        "испуганно", "учениками", "отношения", "посмотрел", "испугался", "лесничего", "скверными", "невинными",
                        ...
                        "вернулись", "взрослого", "находился", "предметов", "сбрасывал", "свободные", "сделаться", "оборотами",
                        "занавески", "презирали", "мгновения", "умолкнуть")},
