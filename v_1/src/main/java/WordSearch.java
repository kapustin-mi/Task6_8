...
public class WordSearch {
    ...
    public List<String> findWords() {
        if (text == null || quantity <= 0 || length <= 0) {
            ...
            HashMap<String, Integer> hashMap = new HashMap<>(allWords.size());
    ...
    private int addNextWords(List<String> returnWords, HashMap<String, Integer> hashMap, int maxQuantity) {
    ...
    private int checkKeyAndQuantity(HashMap<String, Integer> hashMap, String key, int quantity, List<String> addedWords) {
